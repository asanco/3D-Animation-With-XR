...
public class KinectInputData
{
    ...
    public float handScreenPositionMultiplier = 15f;
    ...
    {
        return Camera.main.WorldToScreenPoint(new Vector3(HandPosition.x+15, HandPosition.y, HandPosition.z - handScreenPositionMultiplier));
    }
